...
//        Logger.getLogger(getClass()).info("身份认证：" + this.getClass().getSimpleName() + ".doGetAuthenticationInfo()");
//
...
//        } else if(UserState.FROZEN.getValue().equals(loginUser.getState())) {
//            throw new DisabledAccountException("此帐号已禁止登录！");
//        } else {
//            //登录成功
//            loginUser.setLastLogin(LocalDateTime.from(Instant.now()));
//            loginUser.update();
//            // 重置登录次数计数
//            loginCounterCache.set(SHIRO_LOGIN_COUNT + username, "0");
//        }
